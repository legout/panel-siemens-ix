...
def get_categorical_palette(dark_theme: bool = False, n_colors: int = 17, primary:bool=False, opacity:bool=False) -> List[str]:
    """
    ...
    if primary:
        return pmui.theme.generate_palette(color=colors.primary["main"], n_colors=n_colors)
